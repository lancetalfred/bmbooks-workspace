...
- Name: searchanise.spec.js >> Searchanise — staging >> genre keyword search returns instant results
- Location: tests/searchanise.spec.js:86:3
    ...
    - generic [ref=f1e4]:
      ...
      - generic [ref=f1e15]:
        - generic [ref=f1e18]:
          ...
          - generic [ref=f1e21]:
            - generic [ref=f1e22]:
              - generic [ref=f1e23]: BMBooks - Staging
              - generic [ref=f1e24]: Draft
            - generic [ref=f1e25]:
              - link "Password protected" [ref=f1e26] [cursor=pointer]:
                - /url: https://admin.shopify.com/store/1twhis-a1/online_store/preferences?tutorial=unlock
                - generic [ref=f1e27]: Password protected
              - img [ref=f1e31]
        - generic [ref=f1e35]:
          - button "Hide bar" [ref=f1e37] [cursor=pointer]:
            - generic [ref=f1e38]: Hide bar
          - button "Exit preview" [ref=f1e40] [cursor=pointer]:
            - generic [ref=f1e41]: Exit preview
          - button "Copy link" [ref=f1e44] [cursor=pointer]:
            - img [ref=f1e48]
            - generic [ref=f1e50]: Copy link
```
